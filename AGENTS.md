...
raise HTTPException(status_code=404, detail=_("Game not found"))
```
...
Extend with resource-oriented endpoints as features are added. Keep routers thin; implement logic in services.
