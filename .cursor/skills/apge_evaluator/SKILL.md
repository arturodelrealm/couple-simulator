...
- **Quality commands** the acceptance criteria name (typical: `make test`, `make typecheck`, `make lint`, `make lint-frontend`, `make test-rules-evaluator`). Run from the **repository root** unless the criterion specifies otherwise.
